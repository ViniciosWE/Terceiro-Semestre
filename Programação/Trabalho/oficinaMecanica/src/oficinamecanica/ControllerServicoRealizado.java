...
public class ControllerServicoRealizado {
    ...
    public void inserirServicoRealizado(ServicoRealizado sr) {
        try {
            ...
            // Atualiza valor total da ordem somando
            ...
            System.out.println("Erro ao inserir serviço realizado: " + e.getMessage());
        }
    }
    ...
    public List<ServicoRealizado> listarServicosRealizados() {
        ...
        try {
            Connection conn = Conexao.abrirConexao();
            String sql = "SELECT * FROM ServicoRealizado ORDER BY id";
            ...
            System.out.println("Erro ao listar serviços realizados: " + e.getMessage());
        }
        return lista;
    }
    ...
    public void alterarServicoRealizado(ServicoRealizado sr) {
        try {
            ...
            System.out.println("Erro ao alterar serviço realizado: " + e.getMessage());
        }
    }
    ...
    public void excluirServicoRealizado(int id) {
        try {
            ...
            System.out.println("Erro ao excluir serviço realizado: " + e.getMessage());
        }
    }
