...
public class ControllerServico {
    ...
    public List<Servico> listarServicos() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                s.setDescricao(rs.getString("descricao")); // agora pega descrição
    ...
    public Servico buscarServicoPorNome(String nomeBusca) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                servico.setDescricao(rs.getString("descricao")); // mantém aqui
    ...
    public void alterarServico(Servico servico) {
        try {
            ...
            System.out.println("Erro ao alterar serviço: " + e.getMessage());
        }
    }
