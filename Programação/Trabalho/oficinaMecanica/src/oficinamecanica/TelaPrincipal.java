...
public class TelaPrincipal extends TApplication {
    ...
    public void telaCadastrarCliente() {
        ...
        window.addButton("Incluir", 10, 8, new TAction() {
            public void DO() {
                ...
                window.getApplication().messageBox("Sucesso", "Cliente incluído com sucesso!");
            }
        });
        ...
        window.addButton("Incluir", 10, 10, new TAction() {
            public void DO() {
                try {
                    ...
                    window.getApplication().messageBox("Sucesso", "Serviço incluído com sucesso!");
                } catch (NumberFormatException e) {
                    window.getApplication().messageBox("Erro", "Preço inválido!");
                }
            }
        });
        ...
        comboBox = new TComboBox(window, 12, 2, 30, nomesServicos, 0, 5, new TAction() {
            public void DO() {
                try {
                    ...
                    window.getApplication().messageBox("Erro", "Falha ao carregar serviço: " + ex.getMessage());
                }
            }
        });
        ...
        window.addButton("Alterar", 10, 16, new TAction() {
            public void DO() {
                try {
                    ...
                    window.getApplication().messageBox("Erro", "ID ou Preço inválido!");
                }
            }
        });
    ...
    public void telaCadastrarOrdemServico() {
        ...
        window.addLabel("Data (AAAA-MM-DD):", 1, 6);
    ...
    public void telaAlterarOrdemServico() {
        ...
        window.addLabel("Data (AAAA-MM-DD):", 1, 12);
        ...
        final TComboBox[] comboOrdem = new TComboBox[1];
            ...
            public void DO() {
                ...
                if (textoSelecionado != null && !textoSelecionado.isEmpty()) {
                    try {
                        ...
                        OrdemServico ordem = controllerOrdemServico.buscarOrdemServicoPorId(idSelecionado);
                        if (ordem != null) {
                            id.setText("" + ordem.getId());

                            Veiculo veiculo = controllerVeiculo.buscarVeiculoPorId(ordem.getIdVeiculo());
                            placaVeiculo.setText(veiculo != null ? veiculo.getPlaca() : "");

                            Mecanico mecanico = controllerMecanico.buscarMecanicoPorId(ordem.getIdMecanico());
                            nomeMecanico.setText(mecanico != null ? mecanico.getNome() : "");
                    ...
                    window.getApplication().messageBox("Erro", "Nenhuma ordem selecionada.");
                }
            }
        });
        ...
        window.addButton("Alterar", 10, 18, new TAction() {
            public void DO() {
                try {
                    ...
                    OrdemServico ordem = controllerOrdemServico.buscarOrdemServicoPorId(idOrdem);
                    if (ordem != null) {
                        ordem.setData(dataa.getText());
                        ordem.setDescricao(descricao.getText());
                    ...
                    window.getApplication().messageBox("Erro", "Valor inválido.");
                } catch (Exception e) {
                    window.getApplication().messageBox("Erro", "Erro ao alterar: " + e.getMessage());
                }
            }
        });
...
//---Serviço Realizado---//
    public void telaCadastrarServicoRealizado() {
        ...
        // ---- ComboBox de Ordens mostrando placas ----
        ...
        final TComboBox[] comboServico = new TComboBox[1];
        ...
        window.addButton("Incluir", 10, 10, new TAction() {
            public void DO() {
                try {
                    ...
                    // Buscar ID da Ordem pelo texto selecionado
                    ...
                    window.getApplication().messageBox("Erro", "Quantidade inválida!");
                }
            }
        });
    ...
    public void telaAlterarServicoRealizado() {
        ...
        final TComboBox[] comboSR = new TComboBox[1];
            ...
            public void DO() {
                try {
                    ...
                    if (sr != null) {
                        ...
                        OrdemServico ordem = controllerOrdemServico.buscarOrdemServicoPorId(sr.getIdOrdemServico());
                        Servico servico = controllerServico.buscarServicoPorId(sr.getIdServico());

                        nomeServico.setText(servico != null ? servico.getNome() : "");
        ...
        window.addButton("Alterar", 10, 18, new TAction() {
            public void DO() {
                try {
                    ...
                    window.getApplication().messageBox("Erro", "Quantidade ou Preço inválidos!");
                }
            }
        });
