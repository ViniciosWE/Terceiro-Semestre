...
DELETE FROM funcionarios WHERE cod_depto = 1;

--exclua os funcionarios que são do sexo feminino e que possuem slario maior que 1200 reais--
DELETE FROM funcionarios WHERE sexo = 'F' AND salario > 1200;
--

--update
--ATUALIZE OS SALARIOS DE TODAS AS MULHERES EM 14,25%--
UPDATE funcionarios SET salario = (salario + (salario * 0.1425)) WHERE sexo = 'F'; 
UPDATE funcionarios SET salario = salario * 1.1425 WHERE sexo = 'F';  -- os dois são iguais--
